...
avd30$cons[do_i] = 34 # meaning drop out 
avd30$exercise[do_i] = -100
...
# need to change exercises invovled 

rs_i = c(
  seq(which(coln46 == 'B10Q25A'), which(coln46 == 'B10Q25F'), by = 3),  
  seq(which(coln46 == 'B10Q25L'), which(coln46 == 'B10Q25BB'), by = 3),
  seq(which(coln46 == 'B10Q25GG'), which(coln46 == 'B10Q25II'), by = 3)
  )
...
save(avd_all, file = 'K:/Behavioural/Nicholas Gregory/Early data analysis/PAdata_01.Rdata')
